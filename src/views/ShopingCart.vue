              ...
              <div class="col-lg-12 text-left">
                <div class="proceed-checkout">
                  <ul>
                    ...
                    <li class="subtotal mt-3">
                      Total Biaya <span>${{ biaya }}.00</span>
                    </li>
                    <li class="subtotal mt-3">
...
<script>
import HeaderShyna from "@/components/HeaderShayna.vue";
...
export default {
  ...
  methods: {
    ...
    checkout() {
      ...
      axios
        .post("http://localhost:8000/api/checkout", items)
